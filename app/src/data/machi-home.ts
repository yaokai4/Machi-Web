...
export const marketingCopy = {
  zh: {
    ...
    founder: {
      ...
      avatar: "姚",
      readMore: "阅读完整创始人故事",
      bio: "2019 年我来日本留学。Machi 没有写在哪份商业计划里——它是从我一次次找房、跑手续、找工作、慢慢读懂一座陌生城市的过程里长出来的。",
      quote: "“比起再多一个信息平台，我更想让一个刚到陌生城市的人，少一点无措，多一点能真正落地的生活。”",
      paragraphs: [
        "我是姚凯，Machi 是我一个人从第一行代码写到现在的产品。",
        "2019 年 10 月，我拖着两个行李箱落地日本。后来才慢慢明白，真正磨人的从来不是某一件大事，而是那些没人提前告诉你的小事：第一晚住哪、区役所的表格怎么填、打工去哪找、网上那么多说法到底信谁。",
        "这些答案其实都在，只是散在各种群聊、App、地方网站、学长学姐的记忆里，还隔着好几种语言。刚来的人很难分辨真假；待久了的人，也没有一个地方，能把踩过的坑和走顺的路好好留下来。",
        "Machi 就是从这里长出来的。我不想再做一个冷冰冰的信息库，也不想多一条刷不到底的动态——我想让一座城市里的经验、需求和回应，各自有个清楚的去处。",
        "名字取自日语的「街（まち）」。对我来说，街从来不只是地图上的一个点，而是一个人慢慢学会生活、遇见了谁，也允许自己重新开始的地方。",
        "我想把那些细小却要紧的声音留下来：有人开口问，有人把走过的路讲给他听，于是他能少绕一段弯，早一点在陌生的城市里，找到自己的节奏。",
      ],
      closing: "让散落的信息，重新拥有城市的坐标。\n让陌生的地方，慢慢长出生活的轮廓。\n让每一次认真的发问，都能等到一个回应。",
      siteEyebrow: "继续认识我",
      siteTitle: "在 Machi 之外，我也一直在写作、设计和动手做东西。",
      siteBody: "在 yaokai.me，我写下做产品的思考、走过的弯路，和还在发生的作品。它不是另一份履历，而是我一直在创造的现场。",
  ...
  en: {
    ...
    founder: {
      ...
      bio: "I came to Japan as a student in 2019. Machi was never written into a business plan — it grew out of finding apartments, filling in forms, looking for work, and slowly learning how a strange city actually works.",
      quote: "“I didn’t want to add one more information platform. I wanted someone newly arrived in a strange city to feel a little less lost — and a little more able to actually settle in.”",
      paragraphs: [
        "I’m Yao Kai, and I’ve built Machi on my own, from the very first line of code.",
        "I landed in Japan in October 2019 with two suitcases. What wears you down, I learned, is rarely one big thing. It’s the small ones nobody warns you about: where to sleep the first night, how to fill in the ward-office forms, where to find a part-time job, whose advice online to actually trust.",
        "The answers were out there — just scattered across group chats, apps, local sites, and the memories of people a year ahead of me, in several languages at once. Newcomers can’t tell what’s reliable; the people who’ve stayed have nowhere good to leave what they learned the hard way.",
        "Machi grew straight out of that. I didn’t want another cold database, or one more feed you never reach the bottom of — I wanted a city’s knowledge, its real needs, and the replies between people to each have a clear place to live.",
        "The name comes from the Japanese word 街 (machi). To me a machi is never just a dot on a map. It’s where a person learns how to live, meets the people they meet, and is allowed to begin again.",
        "I want to keep the small, important voices from washing away: someone asks, someone who has walked that road answers, and a stranger finds their footing in an unfamiliar city a little sooner.",
      ],
      closing: "Give scattered information the coordinates of a city.\nLet an unfamiliar place slowly take the shape of a life.\nGive every honest question the chance of a real reply.",
      siteEyebrow: "Beyond Machi",
      siteTitle: "Outside Machi, I keep writing, designing, and making things.",
      siteBody: "At yaokai.me I keep notes on building products, the detours that got me here, and the work still taking shape. Less a résumé than a live record of what I’m making.",
  ...
  ja: {
    ...
    founder: {
      ...
      bio: "2019年、留学のため日本へ来ました。Machi は事業計画書から始まったのではありません。部屋を探し、手続きに戸惑い、仕事を探し、知らない街の仕組みを少しずつ覚えていく——その日々から育ちました。",
      quote: "「情報サービスをもう一つ増やしたいのではなく、知らない街に来たばかりの人が、少し迷わず、少し早く暮らしに根を下ろせるようにしたかったんです。」",
      paragraphs: [
        "姚凱です。Machi は、最初の一行から一人でつくり続けています。",
        "2019年10月、スーツケース二つで日本に着きました。やがて気づいたのは、人を消耗させるのは大きな出来事ではなく、誰も先に教えてくれない小さなことの積み重ねだということ。初日どこに泊まるか、区役所の書類の書き方、バイトの探し方、ネットのどの情報を信じるか。",
        "答えはどこかにありました。ただ、グループチャット、アプリ、地域サイト、一年先を行く先輩の記憶に散らばり、しかも何種類もの言語をまたいでいた。来たばかりの人には真偽が分からず、長く住む人にも、学んだことを残せる場所がなかった。",
        "Machi はそこから生まれました。冷たいデータベースでも、底まで届かないタイムラインでもなく、街の知恵や必要としていること、人から人への応答が、それぞれにちゃんとした居場所を持てるように。",
        "名前は日本語の「街（まち）」から。私にとって街は、地図上の点ではありません。暮らし方を覚え、誰かと出会い、ときにはもう一度始めることが許される場所です。",
        "小さくても大切な声を、流れて消えるままにしたくない。誰かが問い、その道をすでに歩いた人が答える。そうして見知らぬ街でも、少し早く自分の歩幅が見つかる。そんな場所に育てていきます。",
      ],
      closing: "散らばった情報に、街という座標を。\n見知らぬ土地に、暮らしの輪郭を。\nまっすぐな問いかけに、ちゃんと届く応答を。",
      siteEyebrow: "Machi の外側で",
      siteTitle: "書き、設計し、つくることを続けています。",
      siteBody: "yaokai.me には、プロダクトづくりの思考、ここまで歩いた道、いま形になりつつある仕事を綴っています。履歴書というより、つくり続けている現在地のような場所です。",
      siteCta: "yaokai.me へ",
    },
