...
export const marketingCopy = {
  zh: {
    ...
    hero: {
      ...
      subtitle: "Machi 是一个按国家、城市和语言组织内容的本地生活与同城连接平台。租房、二手、工作、招聘、活动、问答、本地服务、商家优惠、本地小组和真实经验，都可以在这里被看见、被找到、被回应。",
      supporting: "我们从日本开始，正在把城市里的生活信息、真实经验和人与人的连接重新整理起来。之后，Machi Guide 和城市社区将陆续扩展到加拿大、澳洲、英国、法国、德国、韩国、美国等更多地区。",
      primary: "进入 Web Beta",
      secondary: "加入等待名单",
    ...
    featureSection: {
      ...
      body: "Machi 将本地新闻、城市指南、问答、服务、租房、二手、工作、招聘、同城社区、本地小组、美食、活动、语言交换和避坑经验按城市与语言组织起来。",
      groups: [
        {
          title: "City Info",
