...
export const marketingCopy = {
  zh: {
    ...
    announcementsSection: {
      label: "公告中心",
      title: "Machi 最新公告。",
      body: "这里会同步 Machi 的产品进展、首批城市计划、测试邀请、合作开放和重要通知。我们会持续把最值得关注的信息放在这里。",
    ...
    citySection: {
      ...
      body: "东京、洛杉矶、多伦多将首先开放 closed beta。城市卡片展示的是 Beta sample data，用来预览频道、语言和社交场景。",
    ...
    download: {
      label: "从你的城市开始",
      title: "下载 Machi",
      body: "Machi 正在准备 closed beta。东京、洛杉矶、多伦多将首先开放。你可以在 Web Beta 中体验城市首页、发现与搜索、通知、私信、发布内容、个人主页和同城连接。",
      primary: "加入等待名单",
      secondary: "寻找同城连接",
      appStore: "iOS：即将上线",
      ...
      benefits: [
        ...
        ["首批城市开放通知", "东京、洛杉矶、多伦多开放测试时第一时间提醒"],
    ...
    cities: withCityTone([
      ...
      { name: "Los Angeles", country: "United States", description: "工作、活动、约饭、本地服务和多语言社区连接。", posts: "Jobs · Events · Dining · Local Services", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Beta sample data", languageTags: ["EN", "中文", "日本語"], sceneTags: ["Jobs", "Events", "Dining", "Local Services"], highlight: "东西区生活与本地服务需求" },
      { name: "Toronto", country: "Canada", description: "租房、工作、多语言问答和新朋友支持。", posts: "Housing · Jobs · Multilingual Q&A · Meetups", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Beta sample data", languageTags: ["EN", "中文", "日本語"], sceneTags: ["Housing", "Jobs", "Q&A", "Meetups"], highlight: "初到城市的生活支持" },
    ]),
  ...
  en: {
    ...
    hero: {
      ...
      stats: [
        ["Closed beta", "Tokyo / Los Angeles / Toronto"],
        ["14", "city channels"],
        ["3", "中文 / EN / 日本語"],
      ],
    },
    ...
    citySection: {
      label: "Cities",
      title: "First beta cities, grounded in real life scenes.",
      body: "Tokyo, Los Angeles and Toronto will open first in closed beta. City cards show beta sample data for channels, languages and social scenes.",
      badge: "Beta sample data",
    ...
    download: { label: "Start with your city", title: "Download Machi", body: "Machi is preparing for closed beta. Tokyo, Los Angeles and Toronto will open first. In Web Beta, you can use city home, discovery and search, notifications, messages, posting, profiles and local connections.", primary: "Join beta waitlist", secondary: "Find local connections", appStore: "iOS: Coming soon", googlePlay: "Android: Coming soon", webBeta: "Web Beta: Invite-only", formLabel: "Waitlist", formTitle: "Join the city beta waitlist", email: "Email", cityLabel: "Preferred city", languageLabel: "Language preference", intentLabel: "I want to use Machi for", cityOptions: ["Tokyo", "Los Angeles", "Toronto", "Other city"], languageOptions: ["English", "中文", "日本語"], intentOptions: ["Local life info", "Finding friends", "Dining buddies", "Event companions", "Language exchange", "Housing", "Secondhand", "Jobs", "Hiring", "Business promotion", "Local services"], notify: "Join beta waitlist", sending: "Sending…", success: "You're on the Machi city beta waitlist. We'll notify you when your city opens, so you can discover local life and meet people nearby.", errorInvalid: "That email does not look right. Please double-check.", errorSubmit: "Could not submit just now. Please try again.", benefitsTitle: "What you will get", benefits: [["Web Beta invite", "Try city home, discovery, search, notifications, messages, posting and profiles first."], ["First-city opening notices", "Be first to know when Tokyo, Los Angeles and Toronto open."], ["Local connection entry", "Meet local friends, dining buddies, event companions and language exchange partners."]], privacy: "We only email you about launches and city openings. We never sell your email or sign you up for other lists." },
    ...
    cities: withCityTone([
      ...
      { name: "Los Angeles", country: "United States", description: "Jobs, events, dining, local services and multilingual community connection.", posts: "Jobs · Events · Dining · Local Services", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Beta sample data", languageTags: ["EN", "中文", "日本語"], sceneTags: ["Jobs", "Events", "Dining", "Local Services"], highlight: "Westside, Eastside and service demand" },
      { name: "Toronto", country: "Canada", description: "Housing, jobs, multilingual Q&A and support when you are new to the city.", posts: "Housing · Jobs · Multilingual Q&A · Meetups", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Beta sample data", languageTags: ["EN", "中文", "日本語"], sceneTags: ["Housing", "Jobs", "Q&A", "Meetups"], highlight: "Newcomer support and local help" },
    ]),
    features: withFeatureMeta([
  ...
  ja: {
    ...
    hero: {
      ...
      scrollLabel: "続きを見る",
      stats: [["Closed beta", "東京 / ロサンゼルス / トロント"], ["14", "都市チャンネル"], ["3", "中文 / EN / 日本語"]],
    },
    appMockup: {
      title: "街の鼓動",
      region: "日本 · 東京",
    ...
    download: { label: "都市から始めよう", title: "Machi をダウンロード", body: "Machi はクローズドベータを準備中です。東京、ロサンゼルス、トロントから順次公開予定です。Web Beta では、都市ホーム、発見と検索、通知、メッセージ、投稿、プロフィール、同じ街のつながりを利用できます。", primary: "ベータに参加", secondary: "同じ街のつながりを探す", appStore: "iOS：近日公開", googlePlay: "Android：近日公開", webBeta: "Web Beta：招待制", formLabel: "ウェイトリスト", formTitle: "都市ベータに参加", email: "Email", cityLabel: "Preferred city", languageLabel: "Language preference", intentLabel: "I want to use Machi for", cityOptions: ["Tokyo", "Los Angeles", "Toronto", "その他の都市"], languageOptions: ["日本語", "English", "中文"], intentOptions: ["ローカル生活情報", "友達を作る", "食事仲間を探す", "イベント仲間を探す", "言語交換", "住まい", "中古", "仕事探し", "求人", "事業者プロモーション", "地域サービス"], notify: "ベータに参加", sending: "送信中…", success: "Machi の都市ベータウェイトリストに登録されました。あなたの都市で公開されたらお知らせします。ローカル情報を見つけ、同じ街の人ともつながれます。", errorInvalid: "メールアドレスの形式を確認してください。", errorSubmit: "送信に失敗しました。時間をおいて再度お試しください。", benefitsTitle: "登録後に受け取れる内容", benefits: [["Web Beta 招待", "都市ホーム、発見、検索、通知、メッセージ、投稿、プロフィールを先行体験。"], ["初期都市の公開通知", "東京、ロサンゼルス、トロントの公開を最速でお知らせ。"], ["同じ街のつながり", "友達、食事仲間、イベント仲間、言語交換パートナーを見つける入口。"]], privacy: "ローンチと都市公開以外でメールは送りません。メールアドレスを販売することも、他のリストに登録することもありません。" },
    ...
    cities: withCityTone([{ name: "Tokyo", country: "Japan", description: "住まいの注意、食事、言語交換、仲間募集から先行テスト。", posts: "Housing · Dining · Language Exchange · Meetups", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Demo preview", languageTags: ["中文", "EN", "日本語"], sceneTags: ["Housing", "Dining", "Language Exchange", "Meetups"], highlight: "渋谷、新宿、湾岸の暮らし" }, { name: "Los Angeles", country: "United States", description: "仕事、イベント、食事、地域サービス、多言語のつながり。", posts: "Jobs · Events · Dining · Local Services", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Beta sample data", languageTags: ["EN", "中文", "日本語"], sceneTags: ["Jobs", "Events", "Dining", "Local Services"], highlight: "地域ごとの生活とサービス需要" }, { name: "Toronto", country: "Canada", description: "住まい、仕事、多言語 Q&A、新しい街での生活サポート。", posts: "Housing · Jobs · Multilingual Q&A · Meetups", heat: "Closed beta · Waitlist open", status: "Closed beta · Waitlist open", sampleLabel: "Beta sample data", languageTags: ["EN", "中文", "日本語"], sceneTags: ["Housing", "Jobs", "Q&A", "Meetups"], highlight: "新しい街での生活サポート" }]),
