...
export const marketingCopy = {
  ...
  ja: {
    ...
    hero: {
      ...
      subtitle: "新しい街で暮らし始めると、住まい、仕事、譲り合い、手続き、地域のサービス、同じ街の人とのつながりを一つずつ探すことになります。Machi は、その実体験を街と言語ごとに整理し、見つけられて、判断できて、返事が届く場所にします。",
      supporting: "まずは日本で、住まい、就職、留学、日々の手続き、街のコミュニティを丁寧につくります。その後、韓国、オーストラリア、カナダ、米国、英国などへ、必要とされる街から広げていきます。",
      primary: "Web Betaを見る",
      secondary: "創設者の物語を読む",
      ...
      scrollLabel: "続きを見る",
      stats: [["Web Beta", "利用できます"], ["Japan Guide", "生活 · 進学 · 就職"], ["次の街へ", "韓 · 豪 · 加 · 米 · 英"]],
    },
    appMockup: {
      title: "街の鼓動",
      region: "日本 · 東京",
