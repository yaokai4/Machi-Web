...
export const marketingCopy = {
  zh: {
    ...
    hero: {
      ...
      subtitle: "在一座陌生的城市，最难的从来不是看地图，而是那些没人会主动告诉你的事——哪间房别碰、手续按什么顺序办、谁的话可以信。Machi 把这些经验按城市和语言收在一处：看得见，找得到，也真的有人回应。",
      supporting: "我们从日本开始，把每一件事做扎实，再一座城市、一座城市地往外走——韩国、澳洲、加拿大、美国、英国，慢慢来。",
      primary: "进入 Web Beta",
      secondary: "查看创始人故事",
      tertiary: "查看 Machi Guide",
      quaternary: "商家合作申请",
      appStoreCaption: "免费下载",
      appStore: "App Store",
      googlePlayCaption: "即将上线",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "In a new city, the hard part is never the map. It is the things no one tells you — which apartment to avoid, what paperwork comes first, whose advice you can trust. Machi keeps that lived experience in one place, by city and language: easy to find, and answered by real people.",
      ...
      appStoreCaption: "Free download",
      appStore: "App Store",
      googlePlayCaption: "Coming soon",
      googlePlay: "Google Play",
  ...
  ja: {
    ...
    hero: {
      ...
      subtitle: "新しい街でいちばん難しいのは、地図ではありません。誰も教えてくれないこと——避けたほうがいい物件、手続きの順番、信じていい相手。Machi は、そんな実体験を街と言語ごとに一か所へ。見つけやすく、ちゃんと人が返してくれます。",
      supporting: "まずは日本から、一つずつ確かめながら。そして韓国、オーストラリア、カナダ、米国、英国へ、街ごとに少しずつ広げていきます。",
      primary: "Web Betaを見る",
      secondary: "創設者の物語へ",
      tertiary: "Machi Guideを見る",
      quaternary: "事業者提携を申請",
      appStoreCaption: "無料ダウンロード",
      appStore: "App Store",
      googlePlayCaption: "近日公開",
      googlePlay: "Google Play",
