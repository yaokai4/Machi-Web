...
export const marketingCopy = {
  zh: {
    ...
    hero: {
      ...
      titleTop: "Machi",
      titleBottom: "",
      headline: "让陌生的城市，也有生活的门路。",
      subtitle: "Machi 按城市和语言，整理租房、手续、求职、二手、本地服务与真实经验。刚来的人可以少走弯路，住久的人也能把知道的事留给后来者。",
      supporting: "先从日本开始，把 Guide 与城市社区认真做好；再跟随真实需要，走向下一座城市。",
      primary: "进入 Web Beta",
      secondary: "查看创始人故事",
    ...
    founder: {
      eyebrow: "创始人的话",
      title: "我是姚凯。Machi 来自我在日本重新学习生活的经历。",
      name: "姚凯 / YAOKAI",
      role: "Machi 创始人 · 产品创作者",
      meta: "2019 年 10 月来到日本",
      avatar: "姚",
      readMore: "阅读完整创始人故事",
      bio: "2019 年，我来日本留学。找房、办手续、找工作，也重新学习怎样在一座陌生城市里安排日常。Machi 就从这些真实的问题里慢慢成形。",
      quote: "“我想做的，是让人在一座陌生城市里遇到问题时，知道去哪里找，也知道有人愿意回答。”",
      paragraphs: [
        "我是姚凯，Machi 的创始人，也一直参与产品、设计与开发。",
        "2019 年 10 月，我来到日本留学。真正开始生活以后，我才发现，困难往往不在某一件大事，而在一连串必须自己弄明白的小事：住在哪里、手续怎么办、工作从哪里找、网上的经验现在还适不适用。",
        "答案并不是没有。它们散在群聊、社交平台、地方网站和朋友的记忆里，也隔在不同语言之间。刚来的人很难判断；熟悉这里的人想认真分享，也缺少一个能把经验长期留下来的地方。",
        "于是我开始做 Machi。我希望租房、求职、二手、问答、本地服务与社区交流，都能回到具体的城市和语言里。信息有时间与来处，人也能在需要时找到彼此。",
        "Machi 的名字来自日语的「街（まち）」。对我而言，街不是地图上的一个标签，而是人慢慢学会生活、建立关系，也重新找到节奏的地方。",
        "我希望 Machi 保留那些细小却重要的经验。一个人认真写下自己知道的事，另一个人就可能因此少绕一点路，也更早在陌生的城市里安顿下来。",
      ],
  ...
  en: {
    ...
    hero: {
      eyebrow: "A place to begin in every city",
      titleTop: "Machi",
      titleBottom: "",
      headline: "Find your way into a new city.",
      subtitle: "Machi organizes housing, paperwork, jobs, secondhand finds, local services, and first-hand advice by city and language. Newcomers spend less time guessing, while long-time residents can pass useful knowledge on.",
      supporting: "We are starting in Japan, building Guide and local communities with care, then expanding where real demand takes us.",
    ...
    founder: {
      ...
      title: "I’m Yao Kai. Machi grew out of learning how to live in Japan from the ground up.",
      name: "Yao Kai / YAOKAI",
      role: "Founder of Machi · Product maker",
      meta: "Moved to Japan in October 2019",
      avatar: "Y",
      readMore: "Read the full founder story",
      bio: "I came to Japan as a student in 2019. Finding a home, handling paperwork, looking for work, and learning the rhythms of an unfamiliar city gradually became the starting point for Machi.",
      quote: "“I wanted people facing an unfamiliar city to know where to look, and to feel that someone might be willing to answer.”",
      paragraphs: [
        "I’m Yao Kai, the founder of Machi. I continue to work across the product, design, and development.",
        "I came to Japan as an international student in October 2019. Once daily life began, I realized that the hardest part was often a series of small questions: where to live, how to handle paperwork, where to look for work, and whether advice online was still current.",
        "The answers existed, but they were spread across group chats, social platforms, local websites, friends' memories, and several languages. Newcomers struggled to judge what applied to them; people who knew the city well had few places to leave useful experience behind.",
        "That is why I started Machi. Housing, jobs, secondhand exchange, questions, local services, and community conversations should all have a clear city and language context. Information should keep its time and source, and people should be able to find one another when it helps.",
        ...
        "I want Machi to preserve the small pieces of experience that matter. When one person takes the time to explain what they know, someone else may avoid a detour and settle into an unfamiliar city a little sooner.",
      ],
  ...
  ja: {
    ...
    hero: {
      ...
      titleTop: "Machi",
      titleBottom: "",
      headline: "知らない街でも、暮らし方は見つけられる。",
      subtitle: "Machi は、住まい、手続き、仕事、譲り合い、地域サービス、実体験にもとづく情報を、街と言語ごとに整理します。来たばかりの人には手がかりを。長く暮らす人には、経験を次の誰かへ渡せる場所を。",
      supporting: "まずは日本で、Guide と地域コミュニティを丁寧に育てます。その先は、実際の声がある街へ。",
      primary: "Web Betaを見る",
      secondary: "創設者の物語を読む",
    ...
    founder: {
      eyebrow: "創設者から",
      title: "姚凱です。日本で暮らしを一から覚えた経験が、Machi の原点です。",
      name: "姚凱 / YAOKAI",
      role: "Machi 創設者・プロダクト制作者",
      meta: "2019年10月、留学のため来日",
      avatar: "姚",
      readMore: "創設者のストーリーを読む",
      bio: "2019年、留学のため日本へ来ました。住まいを探し、手続きを進め、仕事を探しながら、知らない街で暮らす方法を少しずつ覚えていく。その経験が Machi の出発点になりました。",
      quote: "「知らない街で困ったとき、どこを探せばよいかがわかり、誰かが答えてくれるかもしれない。そんな場所をつくりたいと思いました。」",
      paragraphs: [
        "姚凱です。Machi の創設者として、プロダクト、デザイン、開発に今も携わっています。",
        "2019年10月、留学のため日本へ来ました。実際に暮らし始めてみると、住まい、手続き、仕事探し、ネット上の情報が今も正しいかどうかなど、小さくても避けて通れない疑問が次々に出てきました。",
        "答えは存在していても、グループチャットやSNS、地域サイト、友人の記憶、異なる言語の中に散らばっています。来たばかりの人には自分に合う情報か判断しづらく、街をよく知る人にも経験を残せる場所が多くありません。",
        "そこで Machi をつくり始めました。住まい、仕事、譲り合い、Q&A、地域サービス、コミュニティの会話を、街と言語に結びつけて整理する。情報には時期と背景を、人には必要なときに出会えるきっかけを持たせたいと考えています。",
        "Machi という名前は、日本語の「街（まち）」から取りました。私にとって街は地図上の名称ではなく、暮らしのリズムを覚え、人との関係を築き、少しずつ居場所になっていく場所です。",
        "小さくても役に立つ経験を、流れて消えるままにしたくありません。誰かが知っていることを丁寧に残せば、次の人は遠回りを減らし、知らない街に少し早くなじめるかもしれません。",
      ],
    ...
    common: { open: "開く" },
	    footer: { tagline: "知らない街でも、暮らし方は見つけられる。", description: "役に立つ情報を街に残し、一人の経験が次の誰かにも届くように。", groups: [["ナビ", ["概要", "機能", "ガイド", "ビジネス", "安全", "FAQ"]], ["提携", ["店舗提携", "広告掲載", "採用プロモーション", "住まいプロモーション", "システム提携"]], ["法務", ["プライバシー", "利用規約", "会員規約", "サービス予約規約", "返金ポリシー", "コミュニティ規範", "特定商取引法に基づく表記", "Cookie ポリシー", "お問い合わせ"]]] },
