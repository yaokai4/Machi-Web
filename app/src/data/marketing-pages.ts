...
export const marketingPages: Record<MarketingPageId, Record<MarketingLocale, MarketingPageCopy>> = {
  about: {
    zh: {
      ...
      blocks: [
        { title: "为什么做 Machi", subtitle: "真正的城市，藏在普通人的日常里。", body: "一座城市的生活，不只存在于地图、景点和官方介绍中。它也存在于租房时踩过的坑、打工前想知道的提醒、搬家时需要的经验、周末可以去的活动、一次本地活动讨论、一次求助，和人与人之间真实的分享里。\n\n这些信息常常散落在群聊、社交平台、本地网站和不同语言的信息环境里。Machi 希望把这些原本分散的城市生活重新组织起来，让它们按国家、城市、语言和内容类型被找到。" },
        ...
        { title: "产品方向", variant: "grid", items: [
          ...
          { title: "真实生活", body: "租房、工作、二手、活动、问答、服务都来自城市日常，而不是营销内容。" },
        ...
        { title: "上线路线图", variant: "list", items: [
          ...
          { meta: "2026 Q3", title: "iOS / Android 首批城市开放", body: "东京、洛杉矶、多伦多优先开放，等待名单用户优先获得 App 早期体验资格。" },
        ...
        { title: "联系我们", variant: "contact", body: "合作、媒体、早期开放或城市开放建议都可以联系 hi@machicity.com。" },
      ],
    },
    en: {
      eyebrow: "About Machi",
