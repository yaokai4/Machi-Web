...
export const JP_METRO_CIRCLES: MetroCircle[] = [
  { code: "hokkaido_tohoku", name: "北海道・东北", provinceCodes: ["hokkaido", "aomori", "iwate", "miyagi", "akita", "yamagata", "fukushima"] },
  { code: "kanto", name: "关东", provinceCodes: ["ibaraki", "tochigi", "gunma", "saitama", "chiba", "tokyo", "kanagawa"] },
  { code: "chubu", name: "中部", provinceCodes: ["niigata", "toyama", "ishikawa", "fukui", "yamanashi", "nagano", "gifu", "shizuoka", "aichi"] },
  { code: "kansai", name: "近畿・关西", provinceCodes: ["mie", "shiga", "kyoto", "osaka", "hyogo", "nara", "wakayama"] },
  { code: "chugoku", name: "中国地区", provinceCodes: ["tottori", "shimane", "okayama", "hiroshima", "yamaguchi"] },
  { code: "shikoku", name: "四国", provinceCodes: ["tokushima", "kagawa", "ehime", "kochi"] },
  { code: "kyushu_okinawa", name: "九州・冲绳", provinceCodes: ["fukuoka", "saga", "nagasaki", "kumamoto", "oita", "miyazaki", "kagoshima", "okinawa"] },
];
...
const PROVINCE_NAMES: Record<string, RegionNameMap> = {
  ...
  "jp.aomori": { "zh-Hans": "青森县", "zh-Hant": "青森縣", en: "Aomori", ja: "青森県" },
  "jp.iwate": { "zh-Hans": "岩手县", "zh-Hant": "岩手縣", en: "Iwate", ja: "岩手県" },
  "jp.akita": { "zh-Hans": "秋田县", "zh-Hant": "秋田縣", en: "Akita", ja: "秋田県" },
  "jp.yamagata": { "zh-Hans": "山形县", "zh-Hant": "山形縣", en: "Yamagata", ja: "山形県" },
  "jp.fukushima": { "zh-Hans": "福岛县", "zh-Hant": "福島縣", en: "Fukushima", ja: "福島県" },
  "jp.toyama": { "zh-Hans": "富山县", "zh-Hant": "富山縣", en: "Toyama", ja: "富山県" },
  "jp.fukui": { "zh-Hans": "福井县", "zh-Hant": "福井縣", en: "Fukui", ja: "福井県" },
  "jp.yamanashi": { "zh-Hans": "山梨县", "zh-Hant": "山梨縣", en: "Yamanashi", ja: "山梨県" },
  "jp.wakayama": { "zh-Hans": "和歌山县", "zh-Hant": "和歌山縣", en: "Wakayama", ja: "和歌山県" },
  "jp.tottori": { "zh-Hans": "鸟取县", "zh-Hant": "鳥取縣", en: "Tottori", ja: "鳥取県" },
  "jp.shimane": { "zh-Hans": "岛根县", "zh-Hant": "島根縣", en: "Shimane", ja: "島根県" },
  "jp.yamaguchi": { "zh-Hans": "山口县", "zh-Hant": "山口縣", en: "Yamaguchi", ja: "山口県" },
  "jp.tokushima": { "zh-Hans": "德岛县", "zh-Hant": "德島縣", en: "Tokushima", ja: "徳島県" },
  "jp.kagawa": { "zh-Hans": "香川县", "zh-Hant": "香川縣", en: "Kagawa", ja: "香川県" },
  "jp.ehime": { "zh-Hans": "爱媛县", "zh-Hant": "愛媛縣", en: "Ehime", ja: "愛媛県" },
  "jp.kochi": { "zh-Hans": "高知县", "zh-Hant": "高知縣", en: "Kochi", ja: "高知県" },
  "jp.saga": { "zh-Hans": "佐贺县", "zh-Hant": "佐賀縣", en: "Saga", ja: "佐賀県" },
  "jp.nagasaki": { "zh-Hans": "长崎县", "zh-Hant": "長崎縣", en: "Nagasaki", ja: "長崎県" },
  "jp.oita": { "zh-Hans": "大分县", "zh-Hant": "大分縣", en: "Oita", ja: "大分県" },
  "jp.miyazaki": { "zh-Hans": "宫崎县", "zh-Hant": "宮崎縣", en: "Miyazaki", ja: "宮崎県" },
...
const CITY_NAMES: Record<string, RegionNameMap> = {
  ...
  "jp.tokyo.hachioji": { "zh-Hans": "八王子", "zh-Hant": "八王子", en: "Hachioji", ja: "八王子" },
  "jp.tokyo.machida": { "zh-Hans": "町田", "zh-Hant": "町田", en: "Machida", ja: "町田" },
  "jp.tokyo.tachikawa": { "zh-Hans": "立川", "zh-Hant": "立川", en: "Tachikawa", ja: "立川" },
  "jp.tokyo.musashino": { "zh-Hans": "武藏野", "zh-Hant": "武藏野", en: "Musashino", ja: "武蔵野" },
  "jp.osaka.sakai": { "zh-Hans": "堺", "zh-Hant": "堺", en: "Sakai", ja: "堺" },
  "jp.osaka.suita": { "zh-Hans": "吹田", "zh-Hant": "吹田", en: "Suita", ja: "吹田" },
  "jp.osaka.toyonaka": { "zh-Hans": "丰中", "zh-Hant": "豐中", en: "Toyonaka", ja: "豊中" },
  "jp.osaka.higashiosaka": { "zh-Hans": "东大阪", "zh-Hant": "東大阪", en: "Higashiosaka", ja: "東大阪" },
  "jp.kyoto.uji": { "zh-Hans": "宇治", "zh-Hant": "宇治", en: "Uji", ja: "宇治" },
  "jp.fukuoka.kitakyushu": { "zh-Hans": "北九州", "zh-Hant": "北九州", en: "Kitakyushu", ja: "北九州" },
  "jp.fukuoka.kurume": { "zh-Hans": "久留米", "zh-Hant": "久留米", en: "Kurume", ja: "久留米" },
  "jp.aichi.toyota": { "zh-Hans": "丰田", "zh-Hant": "豐田", en: "Toyota", ja: "豊田" },
  "jp.aichi.okazaki": { "zh-Hans": "冈崎", "zh-Hant": "岡崎", en: "Okazaki", ja: "岡崎" },
  "jp.aichi.ichinomiya": { "zh-Hans": "一宫", "zh-Hant": "一宮", en: "Ichinomiya", ja: "一宮" },
  "jp.kanagawa.sagamihara": { "zh-Hans": "相模原", "zh-Hant": "相模原", en: "Sagamihara", ja: "相模原" },
  "jp.kanagawa.kamakura": { "zh-Hans": "镰仓", "zh-Hant": "鎌倉", en: "Kamakura", ja: "鎌倉" },
  "jp.kanagawa.fujisawa": { "zh-Hans": "藤泽", "zh-Hant": "藤澤", en: "Fujisawa", ja: "藤沢" },
  "jp.kanagawa.yokosuka": { "zh-Hans": "横须贺", "zh-Hant": "橫須賀", en: "Yokosuka", ja: "横須賀" },
  "jp.saitama.kawaguchi": { "zh-Hans": "川口", "zh-Hant": "川口", en: "Kawaguchi", ja: "川口" },
  "jp.saitama.kawagoe": { "zh-Hans": "川越", "zh-Hant": "川越", en: "Kawagoe", ja: "川越" },
  "jp.saitama.tokorozawa": { "zh-Hans": "所泽", "zh-Hant": "所澤", en: "Tokorozawa", ja: "所沢" },
  "jp.saitama.koshigaya": { "zh-Hans": "越谷", "zh-Hant": "越谷", en: "Koshigaya", ja: "越谷" },
  "jp.chiba.funabashi": { "zh-Hans": "船桥", "zh-Hant": "船橋", en: "Funabashi", ja: "船橋" },
  "jp.chiba.matsudo": { "zh-Hans": "松户", "zh-Hant": "松戶", en: "Matsudo", ja: "松戸" },
  "jp.chiba.kashiwa": { "zh-Hans": "柏", "zh-Hant": "柏", en: "Kashiwa", ja: "柏" },
  "jp.chiba.ichikawa": { "zh-Hans": "市川", "zh-Hant": "市川", en: "Ichikawa", ja: "市川" },
  "jp.chiba.narita": { "zh-Hans": "成田", "zh-Hant": "成田", en: "Narita", ja: "成田" },
  "jp.hyogo.nishinomiya": { "zh-Hans": "西宫", "zh-Hant": "西宮", en: "Nishinomiya", ja: "西宮" },
  "jp.hyogo.himeji": { "zh-Hans": "姬路", "zh-Hant": "姬路", en: "Himeji", ja: "姫路" },
  "jp.hyogo.amagasaki": { "zh-Hans": "尼崎", "zh-Hant": "尼崎", en: "Amagasaki", ja: "尼崎" },
  "jp.hokkaido.asahikawa": { "zh-Hans": "旭川", "zh-Hant": "旭川", en: "Asahikawa", ja: "旭川" },
  "jp.hokkaido.hakodate": { "zh-Hans": "函馆", "zh-Hant": "函館", en: "Hakodate", ja: "函館" },
  "jp.miyagi.ishinomaki": { "zh-Hans": "石卷", "zh-Hant": "石卷", en: "Ishinomaki", ja: "石巻" },
  "jp.hiroshima.fukuyama": { "zh-Hans": "福山", "zh-Hant": "福山", en: "Fukuyama", ja: "福山" },
  "jp.okinawa.okinawa": { "zh-Hans": "冲绳", "zh-Hant": "沖繩", en: "Okinawa", ja: "沖縄" },
  "jp.shizuoka.hamamatsu": { "zh-Hans": "滨松", "zh-Hant": "濱松", en: "Hamamatsu", ja: "浜松" },
  "jp.shizuoka.numazu": { "zh-Hans": "沼津", "zh-Hant": "沼津", en: "Numazu", ja: "沼津" },
  "jp.ibaraki.mito": { "zh-Hans": "水户", "zh-Hant": "水戶", en: "Mito", ja: "水戸" },
  "jp.ibaraki.hitachinaka": { "zh-Hans": "常陆那珂", "zh-Hant": "常陸那珂", en: "Hitachinaka", ja: "ひたちなか" },
  "jp.nara.ikoma": { "zh-Hans": "生驹", "zh-Hant": "生駒", en: "Ikoma", ja: "生駒" },
  "jp.mie.tsu": { "zh-Hans": "津", "zh-Hant": "津", en: "Tsu", ja: "津" },
  "jp.nagano.matsumoto": { "zh-Hans": "松本", "zh-Hant": "松本", en: "Matsumoto", ja: "松本" },
  "jp.ishikawa.komatsu": { "zh-Hans": "小松", "zh-Hant": "小松", en: "Komatsu", ja: "小松" },
  "jp.okayama.kurashiki": { "zh-Hans": "仓敷", "zh-Hant": "倉敷", en: "Kurashiki", ja: "倉敷" },
  "jp.niigata.nagaoka": { "zh-Hans": "长冈", "zh-Hant": "長岡", en: "Nagaoka", ja: "長岡" },
  "jp.tochigi.oyama": { "zh-Hans": "小山", "zh-Hant": "小山", en: "Oyama", ja: "小山" },
  "jp.gunma.maebashi": { "zh-Hans": "前桥", "zh-Hant": "前橋", en: "Maebashi", ja: "前橋" },
  "jp.shiga.kusatsu": { "zh-Hans": "草津", "zh-Hant": "草津", en: "Kusatsu", ja: "草津" },
  "jp.gifu.ogaki": { "zh-Hans": "大垣", "zh-Hant": "大垣", en: "Ogaki", ja: "大垣" },
  "jp.aomori.aomori": { "zh-Hans": "青森", "zh-Hant": "青森", en: "Aomori", ja: "青森" },
  "jp.aomori.hachinohe": { "zh-Hans": "八户", "zh-Hant": "八戶", en: "Hachinohe", ja: "八戸" },
  "jp.iwate.morioka": { "zh-Hans": "盛冈", "zh-Hant": "盛岡", en: "Morioka", ja: "盛岡" },
  "jp.iwate.ichinoseki": { "zh-Hans": "一关", "zh-Hant": "一關", en: "Ichinoseki", ja: "一関" },
  "jp.akita.akita": { "zh-Hans": "秋田", "zh-Hant": "秋田", en: "Akita", ja: "秋田" },
  "jp.yamagata.yamagata": { "zh-Hans": "山形", "zh-Hant": "山形", en: "Yamagata", ja: "山形" },
  "jp.yamagata.tsuruoka": { "zh-Hans": "鹤冈", "zh-Hant": "鶴岡", en: "Tsuruoka", ja: "鶴岡" },
  "jp.fukushima.fukushima": { "zh-Hans": "福岛", "zh-Hant": "福島", en: "Fukushima", ja: "福島" },
  "jp.fukushima.koriyama": { "zh-Hans": "郡山", "zh-Hant": "郡山", en: "Koriyama", ja: "郡山" },
  "jp.fukushima.iwaki": { "zh-Hans": "磐城", "zh-Hant": "磐城", en: "Iwaki", ja: "いわき" },
  "jp.toyama.toyama": { "zh-Hans": "富山", "zh-Hant": "富山", en: "Toyama", ja: "富山" },
  "jp.toyama.takaoka": { "zh-Hans": "高冈", "zh-Hant": "高岡", en: "Takaoka", ja: "高岡" },
  "jp.fukui.fukui": { "zh-Hans": "福井", "zh-Hant": "福井", en: "Fukui", ja: "福井" },
  "jp.yamanashi.kofu": { "zh-Hans": "甲府", "zh-Hant": "甲府", en: "Kofu", ja: "甲府" },
  "jp.wakayama.wakayama": { "zh-Hans": "和歌山", "zh-Hant": "和歌山", en: "Wakayama", ja: "和歌山" },
  "jp.tottori.tottori": { "zh-Hans": "鸟取", "zh-Hant": "鳥取", en: "Tottori", ja: "鳥取" },
  "jp.tottori.yonago": { "zh-Hans": "米子", "zh-Hant": "米子", en: "Yonago", ja: "米子" },
  "jp.shimane.matsue": { "zh-Hans": "松江", "zh-Hant": "松江", en: "Matsue", ja: "松江" },
  "jp.shimane.izumo": { "zh-Hans": "出云", "zh-Hant": "出雲", en: "Izumo", ja: "出雲" },
  "jp.yamaguchi.yamaguchi": { "zh-Hans": "山口", "zh-Hant": "山口", en: "Yamaguchi", ja: "山口" },
  "jp.yamaguchi.shimonoseki": { "zh-Hans": "下关", "zh-Hant": "下關", en: "Shimonoseki", ja: "下関" },
  "jp.tokushima.tokushima": { "zh-Hans": "德岛", "zh-Hant": "德島", en: "Tokushima", ja: "徳島" },
  "jp.kagawa.takamatsu": { "zh-Hans": "高松", "zh-Hant": "高松", en: "Takamatsu", ja: "高松" },
  "jp.ehime.matsuyama": { "zh-Hans": "松山", "zh-Hant": "松山", en: "Matsuyama", ja: "松山" },
  "jp.ehime.imabari": { "zh-Hans": "今治", "zh-Hant": "今治", en: "Imabari", ja: "今治" },
  "jp.kochi.kochi": { "zh-Hans": "高知", "zh-Hant": "高知", en: "Kochi", ja: "高知" },
  "jp.saga.saga": { "zh-Hans": "佐贺", "zh-Hant": "佐賀", en: "Saga", ja: "佐賀" },
  "jp.nagasaki.nagasaki": { "zh-Hans": "长崎", "zh-Hant": "長崎", en: "Nagasaki", ja: "長崎" },
  "jp.nagasaki.sasebo": { "zh-Hans": "佐世保", "zh-Hant": "佐世保", en: "Sasebo", ja: "佐世保" },
  "jp.oita.oita": { "zh-Hans": "大分", "zh-Hant": "大分", en: "Oita", ja: "大分" },
  "jp.oita.beppu": { "zh-Hans": "别府", "zh-Hant": "別府", en: "Beppu", ja: "別府" },
  "jp.miyazaki.miyazaki": { "zh-Hans": "宫崎", "zh-Hant": "宮崎", en: "Miyazaki", ja: "宮崎" },
...
export function regionShortLabel(region?: RegionInfo, locale?: RegionLocale): string {
  ...
  const province = provinceDisplayName(region.country_code, region.province_code, region.province_name, locale);
  const city = cityDisplayName(region.country_code, region.province_code, region.city_code, region.city_name, locale);
  if (region.province_code && province && region.province_code !== region.city_code) return `${province} · ${city}`;
  return city;
}
