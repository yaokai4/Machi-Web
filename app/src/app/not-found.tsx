  ...
  return (
    <div className="min-h-dvh flex items-center justify-center px-6">
      <div className="kx-glass-surface max-w-md w-full p-8 text-center space-y-4 animate-kx-scale-in">
        ...
        <h1 className="text-xl font-bold text-kx-text">页面没有找到</h1>
        ...
        <div className="space-y-2 rounded-kx-lg bg-kx-soft/60 p-4 text-left text-xs leading-5 text-kx-subtle">
          <p><strong className="text-kx-text">English:</strong> This page may have been removed, renamed, or never existed.</p>
          <p><strong className="text-kx-text">日本語:</strong> このページは削除、名称変更、または存在しない可能性があります。</p>
        </div>
