  ...
  return (
    <GuideShell back={{ href: "/guide/jlpt", label: t("JLPT 备考", "JLPT 対策", "JLPT prep") }}>
      <JlptNarrow>
        ...
        {phase === "intro" ? (
          <div className="mt-6">
            <div className="relative overflow-hidden rounded-[26px] border border-[rgb(var(--kx-living-ink))]/[0.07] bg-[rgb(var(--kx-living-surface))] px-6 py-9 text-center shadow-[0_30px_64px_-46px_rgb(var(--kx-shadow)/0.7)]">
              <div
                aria-hidden
              ...
              />
              <span className="relative mx-auto grid h-16 w-16 place-items-center rounded-2xl bg-[rgb(var(--kx-living-accent))]/[0.12] text-[rgb(var(--kx-living-accent))] shadow-[0_14px_30px_-16px_rgb(var(--kx-living-accent)/0.8)]">
                <Target className="h-8 w-8" />
              </span>
              <h2 className="relative mt-5 text-lg font-black leading-snug text-[rgb(var(--kx-living-ink))]">
                {t("十几道题,找到你的起点", "十数問であなたの出発点を", "A dozen questions to find your starting level")}
              </h2>
              <p className="relative mx-auto mt-2.5 max-w-md text-sm font-medium leading-relaxed text-[rgb(var(--kx-living-muted))]">
                {t(
              ...
              <button
                ...
                className="relative mt-6 inline-flex items-center gap-2 rounded-full bg-[rgb(var(--kx-living-accent))] px-6 py-3 text-sm font-black text-white shadow-[0_16px_32px_-16px_rgb(var(--kx-living-accent)/0.9)] transition hover:opacity-90 disabled:opacity-60"
              >
        ...
        {phase === "answering" ? (
          <div className="mt-5">
            <div className="sticky top-0 z-10 -mx-4 mb-3 border-b border-[rgb(var(--kx-living-ink))]/[0.06] bg-[rgb(var(--kx-living-bg))]/85 px-4 py-3 backdrop-blur sm:-mx-5 sm:px-5">
              <JlptProgress
                value={answeredCount}
            ...
            <button
              ...
              className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[rgb(var(--kx-living-accent))] px-6 py-3.5 text-sm font-black text-white shadow-[0_16px_32px_-18px_rgb(var(--kx-living-accent)/0.9)] transition hover:opacity-90 disabled:opacity-50"
            >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid gap-2.5 sm:grid-cols-2">
              <Link
                ...
                className="group flex items-center justify-between gap-3 rounded-[22px] bg-[rgb(var(--kx-living-accent))] px-5 py-4 text-white shadow-[0_20px_40px_-24px_rgb(var(--kx-living-accent)/0.9)] transition hover:opacity-90"
              >
              ...
              <Link
                ...
                className="group flex items-center justify-between gap-3 rounded-[22px] border border-[rgb(var(--kx-living-ink))]/[0.09] bg-[rgb(var(--kx-living-surface))] px-5 py-4 text-[rgb(var(--kx-living-ink))] shadow-[0_20px_44px_-40px_rgb(var(--kx-shadow)/0.7)] transition hover:-translate-y-0.5 hover:border-[rgb(var(--kx-living-accent))]/40"
              >
