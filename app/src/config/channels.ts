...
export const PRIMARY_CHANNELS: ChannelConfig[] = [
  ...
  channel({ key: "services", label: "商家与本地服务", subtitle: "点评、预约、优惠、旅行住宿、景点和生活支持", Icon: Wrench, tone: "orange", contentTypes: ["service", "merchant"], legacySlugs: ["service", "merchant", "business", "businesses", "local-service", "local_services"] }),
...
export const CHANNEL_GROUPS: Array<{ title: string; items: ChannelGroupItem[] }> = [
  ...
  },
  {
    title: "服务商家",
    items: [
      { label: "商家与本地服务", subtitle: "点评、预约、优惠和生活支持", channel: "services", Icon: Store },
...
const CHANNEL_COPY: Record<ChannelKey, Record<ChannelLocale, { title: string; subtitle: string }>> = {
  ...
  services: {
    "zh-Hans": { title: "商家与本地服务", subtitle: "点评、预约、优惠、旅行住宿、景点和生活支持" },
    "zh-Hant": { title: "商家與本地服務", subtitle: "點評、預約、優惠、旅行住宿、景點和生活支援" },
    en: { title: "Businesses & Local Services", subtitle: "Reviews, bookings, deals, stays, attractions, and support" },
    ja: { title: "店舗・地域サービス", subtitle: "口コミ、予約、特典、宿泊、観光、生活サポート" },
  },
  deals: {
...
const GROUP_ITEM_COPY: Record<string, Record<ChannelLocale, { label: string; subtitle: string }>> = {
  ...
  本地服务: {
    "zh-Hans": { label: "商家与本地服务", subtitle: "点评、预约、优惠、旅行住宿、景点" },
    "zh-Hant": { label: "商家與本地服務", subtitle: "點評、預約、優惠、旅行住宿、景點" },
    en: { label: "Businesses & Services", subtitle: "Reviews, bookings, deals, stays, attractions" },
    ja: { label: "店舗・地域サービス", subtitle: "口コミ、予約、特典、宿泊、観光" },
  },
  商家与本地服务: {
    "zh-Hans": { label: "商家与本地服务", subtitle: "点评、预约、优惠和生活支持" },
