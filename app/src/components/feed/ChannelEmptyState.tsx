...
const COPY: Partial<Record<ContentType, Copy>> = {
  ...
  meetup: { icon: "🤝", title: "还没有小组内容", body: "发起一个学习、运动或语言交换讨论,让本地社区参与进来。", cta: "发布小组", tint: "bg-orange-500" },
  dining: { icon: "🍱", title: "还没有美食讨论", body: "发布餐厅、咖啡或本地美食活动讨论。", cta: "发布美食", tint: "bg-rose-500" },
