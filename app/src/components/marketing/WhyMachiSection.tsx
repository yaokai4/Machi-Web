...
> = {
  zh: {
    label: "Why Machi",
    title: "Machi 不是普通信息平台，而是城市生活信息 + 本地经验 + 同城社交 + 真实关系连接。",
    body: "它的独特价值不是“信息很多”，而是在每一座城市，找到生活的回声；在生活的回声里，找到真实的人。",
    machi: "Machi 按城市、语言、频道、兴趣和真实生活场景组织信息与人，让你不仅能找到本地信息，也能认识同城的人。",
    comparisons: [
      ...
      ["普通交友 App", "偏一对一匹配或约会，不适合围绕城市生活、活动、饭局、语言交换和本地互助建立连接。"],
    ],
  },
  en: {
    label: "Why Machi",
    title: "Machi is not a classifieds board. It is local life information + lived experience + city-based social connection + real relationships.",
    body: "The value is not “more posts.” It is finding the echoes of life in every city, then finding real people inside those echoes.",
    machi: "Machi organizes information and people by city, language, channel, interest and real-life scene, so you can find local information and meet people nearby.",
    comparisons: [
      ["WeChat / LINE groups", "Information sinks, search is weak, important things are missed and it is hard to meet people outside the group."],
      ...
      ["Dating apps", "Built for one-to-one matching or dating, not city life, events, dining, language exchange or local mutual help."],
    ],
  },
  ja: {
    label: "Why Machi",
    title: "Machi は単なる情報サイトではなく、地域情報 + 生活経験 + 同じ街のソーシャル + 本物の関係をつなぐ場所です。",
    body: "価値は「情報が多い」ことではありません。すべての街で暮らしの響きを見つけ、その響きの中で本当の人に出会うことです。",
    machi: "Machi は都市、言語、チャンネル、興味、生活シーンで情報と人を整理し、地域情報だけでなく同じ街の人にも出会えるようにします。",
    comparisons: [
      ...
      ["一般的なマッチングアプリ", "一対一やデート向きで、街の暮らし、イベント、食事、言語交換、助け合いには向きません。"],
    ],
  },
};
