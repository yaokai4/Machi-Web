...
const variants: Record<ButtonVariant, string> = {
  ...
  brand:
    "bg-[linear-gradient(110deg,#ff6b4a_0%,#e0354b_46%,#4f46e5_100%)] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.28),0_22px_56px_-24px_rgba(224,53,75,0.65)] ring-1 ring-white/20 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.28),0_26px_64px_-24px_rgba(79,70,229,0.7)] hover:brightness-[1.06] hover:saturate-[1.05]",
  secondary:
