...
> = {
  zh: {
    ...
    languageLabel: "语言",
    sceneLabel: "场景",
    cities: ["Tokyo / Japan", "Osaka", "Los Angeles · Montreal"],
    scenes: ["Dining", "Meetups", "Housing", "Language Exchange", "Events"],
    languages: ["中文", "EN", "日本語"],
    messages: ["我刚到涩谷，也想找饭搭子。", "周末有人一起去活动吗？"],
    posts: [
      { meta: "Tokyo · Dining", title: "周五涩谷有人一起吃拉面吗？", replies: "3 people replied · 中文 / EN", heat: "Rising" },
  ...
  en: {
    ...
    scenes: ["Dining", "Meetups", "Housing", "Language Exchange", "Events"],
    languages: ["中文", "EN", "日本語"],
    messages: ["I just moved near Shibuya. Anyone up for ramen?", "Weekend event companions?"],
    posts: [
      { meta: "Tokyo · Dining", title: "Anyone in Shibuya for ramen this Friday?", replies: "3 people replied · 中文 / EN", heat: "Rising" },
      { meta: "Tokyo · Language Exchange", title: "Looking for Japanese-English exchange near Shibuya.", replies: "12 replies · EN / 日本語", heat: "Hot" },
  ...
  ja: {
    ...
    scenes: ["Dining", "Meetups", "Housing", "Language Exchange", "Events"],
    languages: ["中文", "EN", "日本語"],
    messages: ["渋谷に来たばかりです。ラーメン仲間いますか？", "週末イベントに一緒に行ける人？"],
    posts: [
      { meta: "Tokyo · Dining", title: "金曜に渋谷でラーメンに行ける人いますか？", replies: "3 people replied · 中文 / EN", heat: "Rising" },
      { meta: "Tokyo · Language Exchange", title: "Looking for Japanese-English exchange near Shibuya.", replies: "12 replies · EN / 日本語", heat: "Hot" },
