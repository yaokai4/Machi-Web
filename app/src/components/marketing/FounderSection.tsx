...
export function FounderSection({
  ...
  const founderTitleParts = f.title.match(/^(.+?[。.])\s*(.+)$/)?.slice(1) ?? [f.title];
  ...
  const body = (
    <div className={isFull ? "mx-auto max-w-[1080px]" : "mx-auto max-w-[1040px]"}>
      ...
      >
        ...
        <span aria-hidden="true" className={isFull ? "hidden" : "pointer-events-none absolute -bottom-28 -left-16 h-64 w-64 rounded-full bg-rose-200/30 blur-3xl dark:bg-rose-300/10"} />

        <aside className={isFull ? "mc-founder-surface relative overflow-hidden p-6 sm:p-8" : "relative"}>
          {isFull ? (
            <>
              <span aria-hidden="true" className="pointer-events-none absolute -right-16 -top-20 h-56 w-56 rounded-full bg-white/45 blur-3xl dark:bg-white/10" />
              <span aria-hidden="true" className="pointer-events-none absolute -bottom-24 -left-10 h-56 w-56 rounded-full bg-rose-200/30 blur-3xl dark:bg-rose-300/10" />
            </>
          ) : null}
          <div className="flex items-center gap-4">
            <span
              aria-hidden="true"
              className={isFull
                ? "relative inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-stone-950 text-2xl font-black text-white shadow-[0_14px_34px_-18px_rgba(41,37,36,0.8)] dark:bg-white/12 dark:ring-1 dark:ring-white/15"
                : "inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-stone-950 text-2xl font-black text-white shadow-[0_14px_34px_-18px_rgba(41,37,36,0.8)] dark:bg-white/12 dark:ring-1 dark:ring-white/15"}
            >
              {f.avatar}
            </span>
          ...
          <div className={isFull ? "relative mt-7 border-t border-stone-900/10 pt-6 dark:border-white/15" : "mt-7 max-w-2xl"}>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {!isFull ? (
                <Link
                  href={aboutHref}
                  className="inline-flex min-h-11 items-center gap-2 rounded-full bg-stone-950 px-5 text-sm font-black text-white shadow-[0_18px_46px_-26px_rgba(41,37,36,0.7)] transition hover:-translate-y-0.5 dark:bg-white dark:text-stone-950"
                >
                  {f.readMore}
              ...
              <a
                ...
                className={isFull
                  ? "inline-flex min-h-11 items-center gap-2 rounded-full bg-stone-950 px-5 text-sm font-black text-white shadow-[0_18px_46px_-26px_rgba(41,37,36,0.7)] transition hover:-translate-y-0.5 dark:bg-white dark:text-stone-950"
                  : "inline-flex min-h-11 items-center gap-2 rounded-full border border-stone-900/10 bg-white/45 px-5 text-sm font-black text-stone-800 backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/70 dark:border-white/15 dark:bg-white/10 dark:text-white dark:hover:bg-white/15"}
              >
                {f.siteCta}
  ...
  return (
    <section id="founder" className="relative scroll-mt-24 overflow-hidden px-5 py-14 sm:px-6 lg:py-20">
      <div className="pointer-events-none absolute left-[8%] top-20 -z-10 h-52 w-52 rounded-full bg-rose-300/18 blur-3xl dark:bg-rose-500/10" />
      <div className="pointer-events-none absolute bottom-16 right-[8%] -z-10 h-52 w-52 rounded-full bg-[#b7a4c7]/20 blur-3xl dark:bg-[#8b6f95]/10" />
